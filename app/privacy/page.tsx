...
export const metadata: Metadata = {
  ...
  description: "How FootballCave collects, uses, and protects your information.",
};
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="space-y-8 text-gray-300 leading-relaxed">
          <div>
            ...
            <p>
              Welcome to FootballCave (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). We operate the website
              FootballCave (the &quot;Service&quot;). This Privacy Policy explains how we collect, use,
              disclose, and safeguard your information when you visit our website. Please read
          ...
          <div>
            ...
            <p className="mb-3">
              When you visit FootballCave, certain information is collected automatically,
              including:
            </p>
            ...
            <h3 className="font-medium text-white mt-4 mb-2">Account Data (if applicable)</h3>
            <p>
              If you create an account, we collect your email address and any profile
              information you choose to provide. We use Supabase to manage authentication
              securely.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-3">
              ...
              to track activity on our Service. You can instruct your browser to refuse all
            ...
            <ul className="list-disc list-inside space-y-1 ml-2 mt-2">
              <li>
                ...
                Service to function (e.g., authentication sessions).
              </li>
              <li>
                <strong className="text-white">Analytics cookies</strong> – help us understand
                how visitors interact with the Service (via Vercel Analytics).
              </li>
              <li>
                <strong className="text-white">Advertising cookies</strong> – used by Google
                AdSense to serve relevant ads based on your interests.
              </li>
            </ul>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-white mb-3">5. Google AdSense and Advertising</h2>
            <p className="mb-3">
              We use Google AdSense to display advertisements on our Service. Google AdSense
              uses cookies to serve ads based on your prior visits to our website and other
              sites on the Internet. Google&apos;s use of advertising cookies enables it and its
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                <strong className="text-white">Vercel Analytics</strong> – privacy-friendly
                website analytics.
              </li>
              <li>
              ...
              <li>
                <strong className="text-white">API-Football</strong> – football match data
                provider.
              </li>
            </ul>
            <p className="mt-3">
              Each of these services has its own privacy policy governing their use of
              your data. We encourage you to review their respective policies.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              FootballCave is not directed to children under the age of 13. We do not
