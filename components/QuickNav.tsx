  ...
  const teams = [
    {
      id: 541,
      label: "Real Madrid",
      imgSrc: `${TEAM_IMG_BASE}/541.png`,
      isFlag: false,
    },
    {
      id: 529,
      label: "Barcelona",
      imgSrc: `${TEAM_IMG_BASE}/529.png`,
      isFlag: false,
    },
    { id: 85, label: "PSG", imgSrc: `${TEAM_IMG_BASE}/85.png`, isFlag: false },
    {
      id: 26,
      label: t("argentina"),
      imgSrc: "/images/flags/ar.svg",
      isFlag: true,
    },
    {
      id: 9,
      label: t("nationalSpain"),
      imgSrc: "/images/flags/es.svg",
      isFlag: true,
    },
    {
      id: 2,
      label: t("nationalFrance"),
      imgSrc: "/images/flags/fr.svg",
      isFlag: true,
    },
  ];
